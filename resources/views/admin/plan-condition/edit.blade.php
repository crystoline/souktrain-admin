                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('level')? 'has-error': '' }}">
                                <label>level</label>
                                <input name="level" class="form-control" required type="number" min="1" step="1" value="{{ $plan_condition->level }}">
                                @if ($errors->has('level'))
                                    <span class="help-block">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('user_account_type_id')? 'has-error': '' }}">
                                ...
                                <select name="user_account_type_id" class="form-control" required value="{{ $plan_condition->user_account_type_id }}">
                            ...
                            <div class="form-group{{ $errors->has('amount')? 'has-error': '' }}">
                                <label>Amount</label>
                                <input name="amount" class="form-control" required type="number" min="1" step="1" value="{{ $plan_condition->amount }}">
                            ...
                            <div class="form-group{{ $errors->has('condition_id')? 'has-error': '' }}">
                                ...
                                <select name="condition_id" class="form-control" required type="number" value="{{ $plan_condition->condition_id }}">
                                    <option value="">None</option>
